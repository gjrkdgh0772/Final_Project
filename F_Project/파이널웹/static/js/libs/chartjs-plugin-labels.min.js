...
(function () {
  ...
  Label.prototype.setup = function (chart, options) {
    ...
    if (chart.config.type === 'bar') {
      ...
      this.options.textBaseline = "middle";
    }
  };
  ...
  Label.prototype.renderBaseLabel = function (label, position) {
    ...
    if (typeof label === 'object') {
      ...
      for (var i = 0; i < lines.length; i++) {
        var y = position.y - (this.options.fontSize + (this.options.textMargin*2)) / 2 * lines.length + (this.options.fontSize + (this.options.textMargin*2)) * i;
        ctx.fillText(lines[i], position.x, y+(this.options.textMargin*2));
      }
      ctx.restore();
    }
  };
